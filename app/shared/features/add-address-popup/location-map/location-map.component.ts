...
export class NewLocationMapComponent implements OnInit {
  ...
  updateCurrentLocationMarker(location: CurrentLocation) {
    if (location) {
      ...
      if (this.stateModule === 'create-offer') {
  ...
  extractPlaceDetails(place: any) {
    ...
    this.addressInput.addressLine = place.formatted_address ? place.formatted_address : this.addressInput.addressLine;
